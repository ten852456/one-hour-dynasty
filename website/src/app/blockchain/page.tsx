...
export default function BlockchainPage() {
  ...
  const [selectedStakeAmount, setSelectedStakeAmount] =
    useState(DEFAULT_STAKE_AMOUNT);
  const [selectedLockDuration, setSelectedLockDuration] = useState(
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "enhancements" | "memberships" | "offerings"
  >("overview");
   ...
   */
  const validateStakeAmountInput = useCallback(
  ...
  const handleStake = useCallback(async () => {
    ...
    const result = await stake(
      amount,
      Number(selectedLockDuration) * 24 * 60 * 60,
    );
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-black via-red-950/10 to-black overflow-hidden pt-16">
        ...
        <div className="fixed inset-0 pointer-events-none">
          ...
          <div
            className="absolute top-1/4 left-1/4 w-96 h-96 bg-red-900/20 rounded-full blur-3xl animate-pulse"
            style={{ animationDuration: "4s" }}
          />
          <div
            className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-yellow-900/20 rounded-full blur-3xl animate-pulse"
          ...
          <div className="text-center py-32">
            <div className="flex justify-center mb-8">
              <div className="relative w-32 h-32">
                <div
                  className="absolute inset-0 bg-yellow-500/20 rounded-full blur-3xl animate-pulse"
            ...
            <div className="relative mb-6">
              <div
                className="absolute inset-0 bg-gradient-to-r from-yellow-600 via-red-500 to-yellow-600 blur-2xl opacity-50 animate-pulse"
                style={{ animationDuration: "3s" }}
              />
            ...
            <p className="relative text-xl md:text-2xl text-gray-400 mb-12">
              ...
              <span className="text-yellow-400 drop-shadow-[0_0_8px_rgba(234,179,8,0.6)]">
                Sect Treasury
              </span>
            </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-red-950/10 to-black overflow-hidden pt-16">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              {subscriptionInfo?.isActive && (
                <div className="bg-gradient-to-br from-red-950/50 to-black border border-green-900/50 rounded-lg px-4 py-2 text-center min-w-[120px]">
                  ...
                  <p className="text-sm font-bold text-green-400">
                    {subscriptionInfo.daysRemaining}d
                  </p>
                </div>
              )}
              {stakeInfo && (
                  ...
                  {stakingTiers.map((tier, idx) => (
                    ...
                    >
                      ...
                      <p className="text-yellow-400 text-sm font-medium">
                        {tier.stakeAmountFormatted} WUXIA
                      </p>
                  ...
                  <div className="space-y-3">
                    ...
                    {showApproval && (
                      <div className="mb-4 p-3 bg-yellow-500/20 border border-yellow-500/50 rounded-lg">
                        ...
                        <p className="text-yellow-400/80 text-xs mb-3">
                          You need to approve the staking contract to spend your
                          WUXIA tokens. This is a one-time approval.
                        </p>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleStakeAmountChange(e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setSelectedLockDuration(e.target.value)
                        }
                  ...
                  <div className="bg-black/50 border border-green-900/50 rounded-lg p-4">
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-white font-medium">
                          {stakeInfo.lockDurationDays} days
                        </span>
                      </div>
        ...
        {isTxPending && (
          <div
            className="fixed bottom-4 right-4 bg-gradient-to-r from-red-600 to-red-700 text-white px-6 py-3 rounded-lg shadow-2xl shadow-red-900/50 flex items-center gap-3 border border-red-500/50"
            role="status"
            aria-live="polite"
          >
            <svg
